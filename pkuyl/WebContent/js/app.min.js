 ...
 * 2014-12-26
 * http://www.liveapp.cn
 * Copyright (c) 2014 云来网络 */
define("lib/iscroll/iscroll", [],
function(a, b, c) { !
	function(a, b, d) {
		function e(a, c) {
		...
		function f(a, c, d) {
			...
			"h" == a ? (d === !0 && (e.style.cssText += ";height:7px;left:2px;right:2px;bottom:0", f.style.height = "100%"), e.className = "iScrollHorizontalScrollbar") : (d === !0 && (e.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px", f.style.width = "100%"), e.className = "iScrollVerticalScrollbar"),
		...
		function g(c, d) {
			...
			this.maxPosX = 0,
			this.maxPosY = 0,
			this.options.interactive && (this.options.disableTouch || (i.addEvent(this.indicator, "touchstart", this), i.addEvent(a, "touchend", this)), this.options.disablePointer || (i.addEvent(this.indicator, "MSPointerDown", this), i.addEvent(a, "MSPointerUp", this)), this.options.disableMouse || (i.addEvent(this.indicator, "mousedown", this), i.addEvent(a, "mouseup", this))),
		...
		i = function() {
			...
			e.momentum = function(a, b, c, e, f, g) {
				...
				h = a + k * k / (2 * g) * (0 > j ? -1 : 1),
				i = k / g,
				e > h ? (h = f ? e - f / 2.5 * (k / 8) : e, j = d.abs(h - a), i = j / k) : h > 0 && (h = f ? f / 2.5 * (k / 8) : 0, j = d.abs(a) + h, i = j / k),
				{
		...
		e.prototype = {
			...
			_start: function(a) {
				if (! (1 != i.eventType[a.type] && 0 !== a.button || !this.enabled || this.initiated && i.eventType[a.type] !== this.initiated)) { ! this.options.preventDefault || i.isBadAndroid || i.preventDefaultException(a.target, this.options.preventDefaultException) || a.preventDefault();
					...
					this.options.useTransition && this.isInTransition ? (this.isInTransition = !1, b = this.getComputedPosition(), this._translate(d.round(b.x), d.round(b.y)), this._execEvent("scrollEnd")) : !this.options.useTransition && this.isAnimating && (this.isAnimating = !1, this._execEvent("scrollEnd")),
					this.startX = this.x,
					this.startY = this.y,
			...
			_end: function(a) {
				if (this.enabled && i.eventType[a.type] === this.initiated) {
					...
					if (this.isInTransition = 0, this.initiated = 0, this.endTime = i.getTime(), !this.resetPosition(this.options.bounceTime)) {
						if (this.scrollTo(f, g), !this.moved) return this.options.tap && i.tap(a, this.options.tap),
						this.options.click && i.click(a),
						...
						f = b.destination, g = c.destination, k = d.max(b.duration, c.duration), this.isInTransition = 1), this.options.snap) {
							...
							this.currentPage = m,
							k = this.options.snapSpeed || d.max(d.max(d.min(d.abs(f - m.x), 1e3), d.min(d.abs(g - m.y), 1e3)), 300),
							f = m.x,
							g = m.y,
							this.directionX = 0,
							this.directionY = 0,
			...
			_initEvents: function(b) {
				...
				i.hasPointer && !this.options.disablePointer && (c(this.wrapper, "MSPointerDown", this), c(d, "MSPointerMove", this), c(d, "MSPointerCancel", this), c(d, "MSPointerUp", this)),
				i.hasTouch && !this.options.disableTouch && (c(this.wrapper, "touchstart", this), c(d, "touchmove", this), c(d, "touchcancel", this), c(d, "touchend", this)),
			...
			_initIndicators: function() {
				...
				this.wrapper.appendChild(b.el), e.push(b))),
			...
			_wheel: function(a) {
				if (this.enabled) {
					...
					if (b *= this.options.invertWheelDirection, c *= this.options.invertWheelDirection, this.hasVerticalScroll || (b = c, c = 0), this.options.snap) return e = this.currentPage.pageX,
				...
				function() {
					...
					if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
						if (this.options.snap === !0) for (c = d.round(k / 2), e = d.round(l / 2); j > -this.scrollerWidth;) {
							...
							j -= k,
							h++
						} else for (g = this.options.snap, a = g.length, b = -1; a > h; h++)(0 === h || g[h].offsetLeft <= g[h - 1].offsetLeft) && (i = 0, b++),
						...
						this.options.snapThreshold % 1 === 0 ? (this.snapThresholdX = this.options.snapThreshold, this.snapThresholdY = this.options.snapThreshold) : (this.snapThresholdX = d.round(this.pages[this.currentPage.pageX][this.currentPage.pageY].width * this.options.snapThreshold), this.snapThresholdY = d.round(this.pages[this.currentPage.pageX][this.currentPage.pageY].height * this.options.snapThreshold))
					}
				}),
				this.on("flick",
				function() {
			...
			_nearestSnap: function(a, b) {
				...
				f == this.currentPage.pageY && (f += this.directionY, 0 > f ? f = 0 : f >= this.pages[0].length && (f = this.pages[0].length - 1), b = this.pages[0][f].y),
				{
					x: a,
					y: b,
					pageX: c,
			...
			_key: function(a) {
				if (this.enabled) {
					...
					e > 0 ? (e = 0, this.keyAcceleration = 0) : e < this.maxScrollX && (e = this.maxScrollX, this.keyAcceleration = 0),
		...
		g.prototype = {
			...
			destroy: function() {
				this.options.interactive && (i.removeEvent(this.indicator, "touchstart", this), i.removeEvent(this.indicator, "MSPointerDown", this), i.removeEvent(this.indicator, "mousedown", this), i.removeEvent(a, "touchmove", this), i.removeEvent(a, "MSPointerMove", this), i.removeEvent(a, "mousemove", this), i.removeEvent(a, "touchend", this), i.removeEvent(a, "MSPointerUp", this), i.removeEvent(a, "mouseup", this)),
			...
			_end: function(b) {
				if (this.initiated) {
					if (this.initiated = !1, b.preventDefault(), b.stopPropagation(), i.removeEvent(a, "touchmove", this), i.removeEvent(a, "MSPointerMove", this), i.removeEvent(a, "mousemove", this), this.scroller.options.snap) {
						...
						e = this.options.snapSpeed || d.max(d.max(d.min(d.abs(this.scroller.x - c.x), 1e3), d.min(d.abs(this.scroller.y - c.y), 1e3)), 300); (this.scroller.x != c.x || this.scroller.y != c.y) && (this.scroller.directionX = 0, this.scroller.directionY = 0, this.scroller.currentPage = c, this.scroller.scrollTo(c.x, c.y, e, this.scroller.options.bounceEasing))
					}
			...
			refresh: function() {
				...
				this.options.listenY && (this.wrapperHeight = this.wrapper.clientHeight, this.options.resize ? (this.indicatorHeight = d.max(d.round(this.wrapperHeight * this.wrapperHeight / (this.scroller.scrollerHeight || this.wrapperHeight || 1)), 8), this.indicatorStyle.height = this.indicatorHeight + "px") : this.indicatorHeight = this.indicator.clientHeight, this.maxPosY = this.wrapperHeight - this.indicatorHeight, "clip" == this.options.shrink ? (this.minBoundaryY = -this.indicatorHeight + 8, this.maxBoundaryY = this.wrapperHeight - 8) : (this.minBoundaryY = 0, this.maxBoundaryY = this.maxPosY), this.maxPosY = this.wrapperHeight - this.indicatorHeight, this.sizeRatioY = this.options.speedRatioY || this.scroller.maxScrollY && this.maxPosY / this.scroller.maxScrollY),
				this.updatePosition()
			},
			updatePosition: function() {
				...
				this.x = a,
				this.y = b,
				this.scroller.options.useTransform ? this.indicatorStyle[i.style.transform] = "translate(" + a + "px," + b + "px)" + this.scroller.translateZ: (this.indicatorStyle.left = a + "px", this.indicatorStyle.top = b + "px")
			},
			_pos: function(a, b) {
		...
		e.utils = i,
		"undefined" != typeof c && c.exports ? c.exports = e: a.IScroll = e
	} (window, document, Math)
}),
define("lib/youku/jsapi", [],
function(require, exports, module) {
	...
	function() {
		...
		function E(a, b) {
			...
			for (g = 0; 256 > g; g++) e = (e + d[g] + a.charCodeAt(g % a.length)) % 256,
			c = d[g],
			d[g] = d[e],
			d[e] = c;
			for (var h = e = g = 0; h < b.length; h++) g = (g + 1) % 256,
			e = (e + d[g]) % 256,
			c = d[g],
			d[g] = d[e],
			d[e] = c,
		...
		function F(a, b) {
			for (var c = [], d = 0; d < a.length; d++) {
				for (var e = 0,
				e = "a" <= a[d] && "z" >= a[d] ? a[d].charCodeAt(0) - 97 : a[d] - 0 + 26, f = 0; 36 > f; f++) if (b[f] == e) {
					e = f;
					break
				}
		...
		function oa(a) {
			...
			f = a.length;
			var q = [];
			for (d = 0; f - 3 > d; d += 4) e = a.charCodeAt(d) << 24 | a.charCodeAt(d + 1) << 16 | a.charCodeAt(d + 2) << 8 | a.charCodeAt(d + 3),
			q.push(e);
			switch (f % 4) {
			case 0:
				d = 2147483648;
			...
			for (q.push(f >>> 29), q.push(f << 3 & 4294967295), a = 0; a < q.length; a += 16) {
				...
				for (e = l, f = m, g = n, h = o, i = p, d = 0; 19 >= d; d++) j = b(e, 5) + (f & g | ~f & h) + i + k[d] + 1518500249 & 4294967295,
				i = h,
				h = g,
				g = b(f, 30),
				f = e,
				e = j;
				for (d = 20; 39 >= d; d++) j = b(e, 5) + (f ^ g ^ h) + i + k[d] + 1859775393 & 4294967295,
				i = h,
				h = g,
				g = b(f, 30),
				f = e,
				e = j;
				for (d = 40; 59 >= d; d++) j = b(e, 5) + (f & g | f & h | g & h) + i + k[d] + 2400959708 & 4294967295,
				i = h,
				h = g,
				g = b(f, 30),
				f = e,
				e = j;
				for (d = 60; 79 >= d; d++) j = b(e, 5) + (f ^ g ^ h) + i + k[d] + 3395469782 & 4294967295,
				i = h,
				h = g,
				g = b(f, 30),
				f = e,
		...
		VER = "2013/12/2718:35:37",
		VER = "2013/12/3010:49:36",
		VER = "2014/02/1312:25:32",
		VER = "2014/02/1312:27:24",
		VER = "2014/02/1312:28:35",
		VER = "2014/02/1312:30:41",
		VER = "2014/02/1313:35:42",
		VER = "2014/02/1313:41:37",
		VER = "2014/02/1314:14:53",
		VER = "2014/02/1314:18:16",
		VER = "2014/02/1314:19:48",
		VER = "2014/02/1314:20:41",
		VER = "2014/02/1314:21:24",
		VER = "2014/02/1314:24:50",
		VER = "2014/02/1314:26:35",
		VER = "2014/02/1314:28:06",
		VER = "2014/02/1314:30:12",
		VER = "2014/02/1314:32:07",
		VER = "2014/02/1314:35:51",
		VER = "2014/02/1315:39:09",
		VER = "2014/02/1315:51:01",
		VER = "2014/02/1315:51:45",
		VER = "2014/02/1316:22:55",
		VER = "2014/02/1316:27:27",
		VER = "2014/02/1316:35:10",
		VER = "2014/02/1316:35:59",
		VER = "2014/02/1316:44:35",
		VER = "2014/02/1317:35:15",
		VER = "2014/02/1317:36:28",
		VER = "2014/02/1317:38:34",
		VER = "2014/02/1317:43:29",
		VER = "2014/02/1317:44:40",
		VER = "2014/02/1317:46:49",
		VER = "2014/02/1318:18:42",
		VER = "2014/02/1318:33:09",
		VER = "2014/02/1318:39:55",
		VER = "2014/02/1318:42:23",
		VER = "2014/02/1318:44:02",
		VER = "2014/02/14 9:43:04",
		VER = "2014/02/1410:00:37",
		VER = "2014/02/1410:10:07",
		VER = "2014/02/1410:18:01",
		VER = "2014/02/1415:30:49",
		VER = "2014/02/1415:33:12",
		VER = "2014/02/1415:40:27",
		VER = "2014/02/1415:42:25",
		VER = "2014/02/1415:45:31",
		VER = "2014/02/1416:24:23",
		VER = "2014/02/1416:25:33",
		VER = "2014/02/1416:30:01",
		VER = "2014/02/1416:31:28",
		VER = "2014/02/1416:32:55",
		VER = "2014/02/1416:37:01",
		VER = "2014/02/1416:37:35",
		VER = "2014/02/1416:38:49",
		VER = "2014/02/1416:39:41",
		VER = "2014/02/1417:16:21",
		VER = "2014/02/1417:21:10",
		VER = "2014/02/1417:25:42",
		VER = "2014/02/1417:26:56",
		VER = "2014/02/2010:16:51",
		VER = "2014/02/2010:28:18",
		VER = "2014/03/0710:33:23",
		VER = "2014/03/0710:45:32",
		VER = "2014/03/0710:50:10",
		VER = "2014/03/0711:21:36",
		VER = "2014/03/0711:22:05",
		VER = "2014/03/0711:24:22",
		VER = "2014/03/0714:39:06",
		VER = "2014/03/0714:42:45",
		VER = "2014/03/0715:12:07",
		VER = "2014/03/0715:16:31",
		VER = "2014/03/0715:17:40",
		VER = "2014/03/0715:24:32",
		VER = "2014/03/1813:59:22",
		VER = "2014/03/1813:59:59",
		VER = "2014/03/1814:27:38",
		VER = "2014/03/1814:28:44",
		VER = "2014/03/1814:37:05",
		VER = "2014/03/1814:45:56",
		VER = "2014/03/1814:51:40",
		VER = "2014/03/1814:58:33",
		VER = "2014/03/1814:59:10",
		VER = "2014/03/20 9:44:18",
		VER = "2014/03/2811:34:40",
		VER = "2014/04/0115:19:54",
		DEBUG__ = 0,
		0 != DEBUG__ && window.console || (window.console = {},
		...
		e = {
			...
			Log: function(a, b) {
				...
				b && c.addEventListener("error", b, !1),
				c.src = a + "&r_=" + Math.floor(1e4 * Math.random()),
			...
			uniReport: function(a) {
				...
				0 == a.mobile && (a.ua = escape(navigator.userAgent.replace(/[\/\+\*@\(\)\,]/g, ""))),
			...
			showError: function(a, c) {
				...
				b.playerEvents && b.playerEvents.onPlayError && b.playerEvents.onPlayError(c ? c: "该视频格式特殊，请在PC上观看")
			}
		}; !
		function() {
			...
			for (var f in c) - 1 !== navigator.userAgent.indexOf(c[f]) ? (e[f] = !0, e.os += c[f] + " ") : e[f] = !1,
			-1 !== navigator.userAgent.indexOf("Android") && (a = navigator.userAgent.indexOf("Android"), a = navigator.userAgent.substr(a, 10), a > c.isAndroid4 && (e.isAndroid4 = !0, e.os += a + " "));
			...
			try {
				...
				} else if (navigator.plugins && 0 < navigator.plugins.length && (g = navigator.plugins["Shockwave Flash"])) for (var c = 1,
				h = g.description.split(" "), g = 0; g < h.length; ++g) isNaN(parseInt(h[g])) || parseInt(h[g])
			} catch(i) {
				f = c = 1
			}
			e.isSupportFlash = c && !f,
		...
		I.prototype = {
			...
			selectH5MP4: function() {
				...
				e.GetMP4OK = function(c, d) {
					...
					a.startPlay(c, d),
					b.initConfig.events.onMediaSrcOK && b.initConfig.events.onMediaSrcOK(m, d._videoSegsDic[m][0].src)
				},
			...
			selectH5M3U8: function() {
				...
				this._h5player = b,
				e.GetM3U8OK = function(a, c) {
					l.appendItem("phase", "vinfo_m3u8"),
					console.log("videoinfo src = " + c.src),
					b.startPlay(a, c)
				},
				k.playlistconfig = this._playlistconfig,
			...
			processThirdParty: function(a) {
				...
				d = this;
				c.addEventListener(PartnerConstant.OPEN_API_OK,
				function(b) {
					debug.log("thirdparty res ok"),
					d.partner_config = b.data,
					a()
				}),
				c.addEventListener(PartnerConstant.OPEN_API_ERROR,
				function() {
			...
			selectDirectUrl: function(a) {
				...
				this._h5player = b,
				k.playlistconfig = this._playlistconfig,
				k.start(this._vid, this._password, a,
				function(a, c) {
					b.startPlay(a, c)
				})
			},
		...
		Q.prototype = {
			...
			parse: function(a) {
				this._hasResp = !0,
				this.dispatch(null != a.error || 1 != a.status ? {
		...
		k.request = function() {
			...
			this._password && b.initConfig.client_id && b.config.partner_config && 1 == b.config.partner_config.status && 1 == b.config.partner_config.passless && (this._url += "client_id=" + b.initConfig.client_id, this._url += "&"),
		...
		k.m3u8src = function(a) {
			return b.password = this._password,
			b.m3u8src_v2(this._vid, a)
		},
		k.total = function(a) {
			for (var b in a.segs) {
				for (var c = 0,
				d = 0,
				e = 0; e < a.segs[b].length; e++) var f = a.segs[b][e],
		...
		k.cleanSrc = function() {
			for (var a = this._videoInfo._videoSegsDic[m], b = 0; b < a.length; b++) a[b].fyksrc = a[b].src,
			a[b].src = k.mp4srcs[b]
		},
		k.processError = function(a) {
			return debug.log("playlist errorcode = " + a.error_code),
			-12 == a.error_code || -13 == a.error_code ? (a.segs = {
				"3gphd": [{
					no: "0",
					size: "0",
					seconds: "0",
		...
		k.init = function(a) {
			...
			if (e.userCache.sid = c.split("_")[0], e.userCache.token = c.split("_")[1], null == a.error_code || !this.processError(a)) if (c = k.total(a), this._videoInfo = new T(a, this._type), this._videoInfo.totalTime = c ? c.totalTime: a.seconds, "m3u8" == this._type) b.defaultVideoType = "mp4",
			null != l.getItem("defaultVideoType") && (b.defaultVideoType = l.getItem("defaultVideoType")),
			-1 == a.streamtypes.indexOf(b.defaultVideoType) && (b.defaultVideoType = "mp4", -1 == a.streamtypes.indexOf("mp4") && (b.defaultVideoType = "flv")),
			debug.log("default = " + b.defaultVideoType),
			this._videoInfo.src = k.m3u8src(b.defaultVideoType),
			this.cache(),
			null == this._callback ? e.GetM3U8OK(this._v, this._videoInfo) : this._callback(this._v, this._videoInfo);
				...
				m ? ("flv" == m && (e.Log(e.uniplayerUrl + p({
					error: "flvonly",
					vid: b.initConfig.vid
		...
		k.fetchDirectSrc = function(a) {
			if (this._fyks = urls = this.getFileUrl(a), this._v && this._v.data[0].trial) {
				for (var a = 0,
				b = this._v.data[0].segs, a = 0; a < b.mp4.length && -1 !== b.mp4[a].k; a++);
				urls.length = a
			}
		...
		var T = function(a, b) {
			...
			for (b in a.segs) {
				for (var d = [], f = 0, g = 0; g < a.segs[b].length; g++) {
					...
					i.seconds = h.seconds,
					h.k && (i.key = h.k),
					i.fileId = this.getFileId(a.streamfileids, b, parseInt(g), c),
					i.type = b,
					i.src = this.getVideoSrc(h.no, a, b, i.fileId),
					d[f++] = i
				}
		...
		T.prototype = {
			...
			getVideoSrc: function(a, c, d, f, g, h) {
				...
				a = c.segs[d][a].k;
				return ("" == a || -1 == a) && (a = c.key2 + c.key1),
				d = "",
				c.show && (d = c.show.show_paid ? "&ypremium=1": "&ymovie=1"),
				c = "/player/getFlvPath/sid/" + e.userCache.sid + "_" + k + "/st/" + j + "/fileid/" + f + "?K=" + a + "&hd=" + i + "&myp=0&ts=" + l + "&ypp=0" + d,
				...
				c += "&oip=" + b.v.data[0].ip,
				"http://k.youku.com" + (c + ((g ? "/password/" + g: "") + (h ? h: "")))
			}
		};
		var R = function(a) {
		...
		function() {
			...
			this.FX.prototype = {
				...
				getAttributes: function() {
					...
					default:
						...
						this.attributes[b].from ? d = this.attributes[b].from: (d = parseFloat(a.getStyle(this.el, b)) || 0, "px" != f && document.defaultView && (a.setStyle(this.el, b, (e || 1) + f), d *= (e || 1) / parseFloat(a.getStyle(this.el, b)), a.setStyle(this.el, b, d + f))),
						this.units[b] = f,
						this.endAttr[b] = e,
						this.startAttr[b] = d
					}
			...
			b = function() {
				...
				return function(b) {
					...
					var c = b.split("-"),
					d = c[0];
					if (1 < c.length) for (var e = 1,
					f = c.length; f > e; e++) d += c[e].charAt(0).toUpperCase() + c[e].substring(1);
					return a[b] = d
				}
			} (),
			c = function() {
		...
		FX.transitions.backBoth = function(a, b, c, d, e) {
			return e = e || 1.70158,
			1 > (a /= d / 2) ? c / 2 * a * a * (((e *= 1.525) + 1) * a - e) + b: c / 2 * ((a -= 2) * a * (((e *= 1.525) + 1) * a + e) + 2) + b
		},
		...
		var pa = function(a) {
			return a = parseInt(a),
			Math.min(Math.max(a, 0), b.videoInfo.totalTime)
		},
		p = function(a) {
			var b, c = [];
		...
		J.prototype = {
			init: function(a) {
				if (a && a.data && a.data[0] && (a.data[0].error_code || a.data[0].error)) {
					...
					case - 1 : this.setMessage(u[ - 1]);
						break;
					case - 2 : this.setMessage(u[ - 2]);
						break;
					case - 3 : this.setMessage(u[ - 3]),
						this.setButton("搜索", this.search);
						break;
					case - 4 : this.setMessage(u[ - 4]),
						this.bind_feedback = b.bindAsEventListener(this, this.feedback),
						this.setButton("在线反馈", this.bind_feedback);
						break;
					case - 9 : this.setMessage(u[ - 9]);
						break;
					case - 5 : this.setMessage(u[ - 5]),
						this.bind_contact = b.bindAsEventListener(this, this.contactOwner),
						this.setButton("联系上传者", this.bind_contact);
						break;
					case - 6 : this._messagetxt.innerHTML = "<input type=password placeholder=输入密码观看视频 class=x-message-input>",
						this.bind_inputpassword = b.bindAsEventListener(this, this.inputPassword),
						this.setButton("确定", this.bind_inputpassword);
						break;
					case - 7 : this._messagetxt.innerHTML = '<input type=password placeholder="对不起,您输入的密码错误,请重新输入" class=x-message-input>',
						this.bind_inputpassword = b.bindAsEventListener(this, this.inputPassword),
						this.setButton("确定", this.bind_inputpassword);
						break;
					case - 8 : this.setMessage(u[ - 8]);
						break;
					case - 15 : this.setMessage(u[ - 15]);
						break;
					case - 25 : this.setMessage(u[ - 25]);
						break;
					case - 26 : this.setMessage(u[ - 26]);
						break;
					default:
			...
			inputPassword: function() {
				...
				c = a.value;
				if (null == c || 0 == c.replace(/\s/g, "").length) a.value = "",
				a.placeholder = "密码为空，请重新输入";
				else {
					var d = this.player;
					b.password = c,
					k.start(this._vid, c, b.config.content,
					function(a, e) {
		...
		W.prototype = {
			init: function(a) { ! a.data[0].trial && !a.data[0].error_code && !a.data[0].error && (this.title.innerHTML = a.data[0].title.substr(0, 20), this.videoState.innerHTML = "<span>时长: " + b.getTime(parseInt(a.data[0].seconds)) + "</span>", this.show())
			},
			show: function() {
		...
		X.prototype = {
			...
			setTip: function(a, c) {
				...
				this._time.innerHTML = b.getTime(pa(a + c)),
		...
		var Y = function(a, c) {
			this._handler = {},
			c && c.data && c.data[0] && c.data[0].dvd && c.data[0].dvd.audiolang ? (this.player = a, this._language = b.get(".x-localization"), this.init(c), this.bindEvent(), this._button = this._language.getElementsByTagName("button")[0], this._panel = this._language.getElementsByTagName("div")[0], this._nodes = this._language.getElementsByTagName("li")) : b.get(".x-localization").style.display = "none"
		};
		Y.prototype = {
			addEventListener: function(a, b) {
				this._handler[a] = b
			...
			init: function(a) {
				for (var a = a.data[0], b = a.dvd.audiolang, c = ["<button class=x-control-btn>", "", "</button>"], d = ["<div class=x-panel><ul>", "", "</ul><div class=x-mask></div>", "</div>"], e = [], f = 0; f < b.length; f++) {
					...
					b[f].vid == a.vidEncoded ? (c[1] = b[f].lang, g += " class=selected>") : g += ">",
					g += b[f].lang + "</li>",
					e[b[f].langid] = g
				}
				d[1] = e.join(""),
			...
			switchLanguage: function(a) {
				...
				} else a[d].innerHTML = a[d].getAttribute("data-language"),
				a[d].className = a[d].className.replace(/[\s]*selected/g, "");
				...
				if ("mp4" == b.config.content) f = this.player.currentTime,
				k.start(c, "", b.config.content,
				function(a, d) {
					if (console.log("switchLanguage vid = " + c), a.data && a.data[0]) {
						...
						null != d._videoSegsDic && null != d._videoSegsDic[m] && (e.video.src = d._videoSegsDic[m][0].src, e.video.load(), e.video.play());
						var g = 0;
		...
		Z.prototype = {
			...
			setProgress: function(a, c) {
				...
				!0 !== c && (this.loadTime = d += Math.max(this.player.bufferedEnd() - a, 0), e = d / b.videoInfo.totalTime + .05, this._load.style.width = 100 * Math.min(Math.max(e, 0), 1) + "%")
			},
		...
		$.prototype = {
			...
			init: function(a) {
				if (null == a.data[0].trial) debug.log("not pay");
					...
					"vod" == this._type ? (this._title.innerHTML = b + "<em class=x-vip>付费影片</em>", this._payBtn.innerHTML = "立即购买") : (this._title.innerHTML = b + "<em class=x-vip>付费包月影片</em>", this._payBtn.innerHTML = "开通影视会员"),
					this.bindEvent(),
					this.show(),
		...
		var aa = function(a, b) {
			...
			this._videoInfo = b,
			this._app_disable = !1,
			this._limitTime = 1200,
			1 == this._videoInfo.controller.app_disable && (this._app_disable = !0),
			this._isLimit = !1,
			1 == this._videoInfo.controller.xplayer_disable && (this._isLimit = !0, this.player.tryDuration = this._limitTime),
			this._isCreated = !1,
		...
		ba.prototype = {
			...
			init: function() {
				for (var a = ["<button class=x-control-btn>", "", "</button>"], b = ['<div class=x-panel style="display:none"><ul>', "", "</ul><div class=x-mask></div>", "</div>"], c = "", d = [], e = ["2", "1.5", "1", "0.8"], f = 0; f < e.length; f++) {
					...
					h = "",
					i = "";
					"1" == g && (h = "", a[1] = A[g], i = " class=selected"),
					c += "<li data-vtype=" + g + i + ">" + h + A[g] + "</li>",
					d.push(A[g])
				}
				b[1] = c,
			...
			switchRate: function(a) {
				...
				for (var b = this.button,
				c = this.nodes,
				d = 0; d < c.length; d++) if (c[d].getAttribute("data-vtype") == a) {
					...
					c[d].innerHTML = A[e],
					c[d].className = c[d].className.replace(/selected/, "")
				}
		...
		ca.prototype = {
			...
			setProgress: function(a, c) {
				...
				this._play.style.width = Math.min(100 * (e + g / f / 2), 100) + "%",
				this._seek.style.left = e * f > f - g ? f - g + "px": 100 * Math.min(Math.max(e, 0), 1) + "%",
				this.uCurrentTime.innerHTML = b.getTime(d),
				!0 !== c && (this.loadTime = d += Math.max(this.player.bufferedEnd() - a, 0), e = d / b.videoInfo.totalTime, this._load.style.width = 100 * Math.min(Math.max(e + .05, 0), 1) + "%")
			},
			resetProgress: function() {
			...
			getRate: function(a, c) {
				...
				return e && (d = parseFloat(b.getCurrentStyle(e).zoom)),
				a / (c * d)
			},
			seek: function(a) {
				var c = (new Date).getTime() - da;
				if (a.srcElement == this._seek || ea > c) return debug.log(c + "," + ea),
				!1;
		...
		fa.prototype = {
			...
			init: function(a) {
				...
				for (c in s) if ( - 1 !== a.streamtypes.indexOf(c) && -1 === g.indexOf(s[c])) {
					var h = "",
					i = "";
					c == b.defaultVideoType && (h = "", d[1] = s[c], i = " class=selected"),
					f += "<li data-vtype=" + c + i + ">" + h + s[c] + "</li>",
					g.push(s[c])
				}
				"" == d[1] && (d[1] = g[0]),
				e[1] = f,
			...
			switchQuality: function(a) {
				...
				for (var c = a.target,
				a = null,
				a = c.getAttribute ? c.getAttribute("data-vtype") : c.parentNode.getAttribute("data-vtype"), c = this._button, d = this._nodes, e = 0; e < d.length; e++) if (d[e].getAttribute("data-vtype") == a) {
					...
					d[e].innerHTML = s[f],
					d[e].className = d[e].className.replace(/selected/, "")
				}
				debug.log("q1"),
			...
			switchQuality_: function(a) {
				a.stopPropagation();
				for (var a = a.target.dataset.vtype,
				b = this._button,
				c = this._nodes,
				d = 0; d < c.length; d++) if (c[d].dataset.vtype == a) {
					if ( - 1 !== c[d].className.indexOf("selected")) return void this.toggleQualityPanel();
					c[d].innerHTML = s[a],
					c[d].className += " selected",
					b.innerHTML = s[a]
				} else c[d].innerHTML = s[c[d].dataset.vtype],
				c[d].className = c[d].className.replace(/selected/, "");
				debug.log("q1"),
				this.toggleQualityPanel();
		...
		ga.prototype = {
			...
			onItemClick: function(a) {
				...
				"x" == a ? this.replay() : (debug.log("related onitemclick" + a + " " + this._info.data[a].videoid), this.player._reporter.sendRecommendLog(this._info.data[a]))
			},
			init: function() {
			...
			buildPanel: function(a) {
				...
				for (var e = Math.floor((this._panel.offsetWidth - 60 + 16) / 166) * Math.floor((this._panel.offsetHeight - 120 + 12) / 97), e = (e > c ? c: e) - 1, e = 0 > e ? 0 : e, c = 0; e > c; c++) {
					...
					h = a[c].link;
					"myoukucom" == b.initConfig.client_id && (h = "http://m.youku.com/smartphone/detail?vid=" + a[c].videoid),
					d.push('<ul class="x-item" data-i=' + c + '><li class="x-item-img"><img src=' + f + '></li><li class="x-item-info"><div class="x-item-title">' + g + '</div><div class="x-item-bg"></div></li><li class="x-item-url"><a href=' + h + ' target="_blank"></a></li><li class="x-item-loading"><div class="x-play-loading"></div></li></ul>')
				}
			...
			buildImgEvent: function() {
				for (var a = this._listinner.getElementsByClassName("x-item-img"), c = 0; c < a.length; c++) b.addEventHandler(a[c], "error", b.bindAsEventListener(this, this.onLoadImgError)),
				b.addEventHandler(a[c], "abort", b.bindAsEventListener(this, this.onLoadImgError))
			},
		...
		ha.prototype = {
			init: function(a) {
				...
				if (null != c && 0 != c.length) {
					...
					for (d[1] = e.join(""), this._slbd.innerHTML = d.join(""), d = "<div class=x-showlist-pages>;<span class=x-showlist-pre></span>;<ul>;;</ul>;<span class=x-showlist-next></span>".split(";"), e = [], i = a.data[0].list_pre ? parseInt(a.data[0].list_pre.seq / 60) : 0, f = 0; f < (c.length - 1) / 60 + 1; f++) a = "",
					f == i && (a = " class=current"),
					g = "<li" + a + "><em>" + (f + 1) + "</em></li>",
					e.push(g);
					d[3] = e.join(""),
		...
		K.prototype = {
			...
			sendTSLog: function(a) {
				...
				1e3 * c), 61 == a) clearTimeout(this.tstimer),
				this.tstimer = null;
				...
				if (0 == this.tsSn) this.tsSn++;
					...
					g.vid = f.videoid,
					g.cf = this.getHDFlag(),
					g.cpt = this.player.currentTime ? Math.floor(this.player.currentTime) : 0,
					g.full = this.player.controls.fullscreenPanel.fullFlag() ? 1 : 0,
					g.lang = this.getLanguage(),
					g.pc = 60 == a ? 0 : 1,
					g.clb = 0,
					g.iku = "m",
					g.pt = this.getPlayTime(),
					g.sn = this.tsSn++,
					g.hi = c,
					g.uid = b.v.user.id,
					g.r = this.signTS(g.vvid + g.vid + g.cpt + g.pt + g.sn),
					e.Log("http://p-log.ykimg.com/tslog?" + n(g))
				}
			},
			signTS: function(a) {
				if (null == a) return 0;
				var b = 0,
				c = a.length;
				for (j = 0; c > j; j++) b = 43 * b + a.charCodeAt(j),
				b %= 1e10;
				return b
			},
			...
			getExtString: function(a) {
				...
				return c.full = this.player.controls.fullscreenPanel.fullFlag(),
			...
			addPlayerStaticReport: function() {
				...
				f = ""; ! d;) {
					for (var f = "",
					g = 0; 20 > g; g++) var h = Math.floor(61 * Math.random()),
			...
			checkScreenRotate: function(a, b) {
				...
				(this.screenDim.w != c || this.screenDim.h != d) && (this.screenDim.w = c, this.screenDim.h = d, debug.log("<b><font color=red>rotate</font></b>"), e.Log(a + b))
			},
					...
					setTimeout(function() {
						if (0 != d._resizeList.length) {
							for (var b = d._resizeList[0].time, c = 0; c < d._resizeList.length; c++) {
								...
								g = d._resizeList[c].h,
								h = d._resizeList[c].time; (f != d.dimension.w || g != d.dimension.h) && (d.dimension.w = f, d.dimension.h = g, (h - b > 800 || c == d._resizeList.length - 1) && e.Log(a + d._resizeList[c].str))
							}
							d._resizeList = []
						}
					},
			...
			sendCustomLoadedTime: function(a) {
				...
				0 == a.mobile && (a.ua = escape(navigator.userAgent.replace(/[\/\+\*@\(\)\,]/g, ""))),
				e.Log("http://passport-log.youku.com/logsys/logstorage/append?project=xplayerloadtime&log=" + p(a))
			},
			sendUepReport: function(a, c, d) { ! 1 !== d && 10 < 100 * Math.random() || (d = "", d = e.isIPAD ? "xplayer_ipad": e.isIPHONE ? "xplayer_iphone": "xplayer_android", a = {
					m: d,
					hd: this.getHDFlag(),
					t: a,
					s: c,
		...
		ja.prototype = {
			...
			buildAdRS: function() {
				for (var a = "http://pl.youku.com/playlist/m3u8?",
				c = {},
				d = {},
				f = this._adinfo.VAL,
				g = 0; g < f.length; g++) {
				...
				return d.push(b.v.data[0].videoid),
				f = encodeURIComponent(D(E(F(b.mk.a4 + "poz" + e.userCache.a2, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), e.userCache.sid + "_" + d.join("") + "_" + e.userCache.token))),
				c.ep = f,
				...
				if (null != this._adinfo && null != this._adinfo.VAL && 0 != this._adinfo.VAL.length) {
					...
					b = 0, c = 0; c < this._adinfo.VAL.length; c++) {
						...
						if (null != d.VID && null != d.VQT) {
							...
							else for (e = 0; e < d.SUE.length; e++) f = b + d.AL,
							a.SU.push({
								T: f,
								U: d.SUE[e].U
							});
							if (b += d.AL, a.CU.push({
								...
								U: d.VC,
								T: b
							}), 0 != this._vt2nodes.length) for (e = 0; e < this._vt2nodes.length; e++) d = this._vt2nodes[e].VC,
							f = this._vt2nodes[e].pos_,
							-1 == f && a.VTVC.push({
								U: d,
								T: 0
							}),
		...
		L.prototype = {
			...
			leftSecond: function() {
				for (var a = this._addata.curnum,
				b = this._addata.seconds.length,
				c = this._addata.seconds[a] - this.video.currentTime, a = a + 1; b > a; a++) c += this._addata.seconds[a];
				return parseInt(c)
			},
			clearTimer: function() {
			...
			onAdPlay: function() {
				...
				1e4),
				this._playTag[a] || (this._playTag[a] = !0, this._adfirsttu = !1, this._adplugin.recordTime("advideo"), l.appendItem("phase", "adplay"))
			},
			uglyClose: function() {
				this.video.src = "",
				this.video.load(),
			...
			onAdEnded: function(a) {
				...
				this.checkVTVC(this._addata.curnum + 1),
				this._addata.curnum < this._addata.urls.length - 1 ? this.onMiddleAdEnded(a) : (this.removeAdEvent(), this._adplugin.hide(), this.clearTimer(), this.dispatch({
			...
			onAdTimeUpdate: function() {
				...
				.5 <= this.video.currentTime && this._adplugin.show(),
		...
		M.prototype = {
			...
			adParse: function(a) {
				if (this.checkSkip(a), l.appendItem("phase", "adinfo"), this.reportTime("adinfo"), this._isAdInfoOk = !0, a && a.VAL) for (var a = this.splitVTVC(a), b = a.VAL, c = 0; c < b.length; c++) this._adsrcs.push(b[c].RS),
		...
		var ka = function(a, c) {
			...
			2 != this.info.VAL[0].VT && (this.init(), this.bindEvent(), this._adreporter = new G(this, c.data)),
			this.loadVC()
		};
		ka.prototype = {
			addEventListener: function(a, b) {
			...
			adjustIMGWH: function() {
				...
				c = this.info.VAL[0].H,
				d = (b.get("#x-player").offsetHeight - 110) / c; (d > 1 || 0 >= d) && (d = 1),
			...
			loadVC: function() { (2 == this.info.VAL[0].VT || 1 == this.info.VAL[0].VT) && x(this.info.VAL[0].VC, "js")
			}
		};
		var la = function(a, b) {
			this._handler = {},
		...
		var ma = function(a, c) {
			...
			this.progressBar = new ca(a),
			this.progressBar.uCurrentTime = this.setting.buttons.currentTime,
			this.miniProgressBar = new Z(a),
			this.fullscreenPanel = new V(a),
			this.interactionPanel = new X(a),
		...
		ma.prototype = {
			init: function(a, c) {
				...
				this._qualityPanel = new fa(this.player, a),
				this._languagePanel = new Y(this.player, a),
				this._playratePanel = new ba(this.player, a),
				this._payPanel = new $(this.player, a),
				this._feedbackPanel = new J(this.player, a),
				this._informationPanel = new W(this.player, a),
				this.tipPanel = new ia(this.player, a),
				this.showlistPanel = new ha(this.player, a),
				this.playLimit = new aa(this.player, a),
				this.bindDynamicEvent()
			},
			bindDynamicEvent: function() {
			...
			bindEvent: function() {
				...
				"directsrc" == b.config.playType && (e.isIPHONE || e.isIPOD ? b.addEventHandler(this.buttons.videobtn, "click", b.bindAsEventListener(this, this.playIPH), !0) : b.addEventHandler(this.buttons.videobtn, "click", this.bind_redirect, !0)),
			...
			onGestureChange: function(a) {
				a.preventDefault();
				var b = -1 !== this.fullscreenPanel.zoomStatus().indexOf("in"); (1.1 < a.scale && b || .9 > a.scale && !b) && (a.method = "m", this.fullscreenPanel.switchFullScreen(a))
			},
			...
			onPauseAdInfoOK: function(a) {
				...
				this._pauseAdPlayer = new ka(this.player, a),
			...
			onEnded: function() {
				...
				null == b.v.data[0].trial && (this._relatedPanel = new ga(this.player, b.v))
			},
			onPlay: function() {
			...
			onTimeUpdate: function(a) {
				if (this.buttons.loading.style.display = "none", a.target == this.player.video) {
					...
					this._payPanel.hasPayInfo() && b >= this._payPanel.tryDuration() && this.onTryPlayEnded(),
		...
		N.prototype = {
			...
			onError: function() {
				...
				}), 0 <= this._retry--) - 1 !== this.video.src.indexOf("m3u8") && (this.video.src = b.m3u8src_v2(b.v.data[0].videoid, b.defaultVideoType)),
				...
				this.seek(this.currentTime);
					...
					this._errorTag = !0,
					b.playerEvents && b.playerEvents.onPlayError && b.playerEvents.onPlayError("抱歉，视频出错，请刷新");
					var a = b.get("#x-player");
			...
			onSuspend: function() {},
			onWaiting: function(a) { (this.isOnePiece() || a.target == this.video) && this.controls.onWaiting(a)
			},
			onSeeked: function() {
			...
			onTimeUpdate: function(a) {
				...
				b.unitedTag && (this.currentTime -= b.unitedTag.offset);
				else {
					for (var c = 0,
					d = 0; r > d; d++) c += parseInt(b.videoInfo._videoSegsDic[m][d].seconds);
			...
			loadNextVideo: function() {
				...
				if (debug.log("loadNextVideo vid = " + a.vidEncoded), a.vidEncoded) {
					...
					k.start(a.vidEncoded, "", b.config.content,
					function(a, b) {
						c.startPlay(a, b);
						try {
							onPlayerStart(d)
			...
			bindEvent: function() {
				...
				b.addEventHandler(this.video, "timeupdate", b.bindAsEventListener(this, this.onTimeUpdateIPH)),
				b.addEventHandler(this.video, "ended", b.bindAsEventListener(this, this.onEndedIPH));
				else {
					var a, c = {
		...
		b.m3u8src = function(a, b) {
			...
			return (e.isIPHONE || e.isIPOD) && (c += "/useKeyFrame/0"),
			c + "/v.m3u8"
		},
		b.m3u8src_v2 = function(a, c) {
			...
			b.password && b.initConfig.client_id && b.config.partner_config && 1 == b.config.partner_config.status && 1 == b.config.partner_config.passless && (d.client_id = b.initConfig.client_id);
			...
			d.ev = "1",
			d.oip = b.v.data[0].ip,
			"http://pl.youku.com/playlist/m3u8?" + n(d)
		},
		...
		b.extend(YoukuHTML5Player.prototype, {
			startPlay: function(a, c, d) {
				a && a.data && a.data[0] && (a.data[0].show = a.data[0].show || {},
				c.abstarttime = (new Date).getTime(), c._playListData = a.data[0], c._user = a.user, b.v = a, b.videoInfo = c, this.setting = {},
				b.extend(this.setting, d), !a.data[0].error_code && !a.data[0].error || !this.processError(a, c, d)) && (this._reporter = new K(this, b.v, b.videoInfo._sid), this.controls = this.setupControls(this), this.controls.init(b.v, b.videoInfo), this.mpieceReport(), this.createIdNode(), this.isNeedAdRequest() ? this.processAd() : (this.controls.bindVideoBtnEvent(), this.realStartPlay()))
			},
			isNeedAdRequest: function() {
				return "undefined" == typeof this._frontAdTag && (this._frontAdTag = !1),
			...
			onUnitedFrontAdInfoOK: function(a) {
				...
				var c = a.data.info;
				if (0 == a.data.info.VAL.length) debug.log("<b>onUnitedFrontAdInfoOK val length == 0 </b>"),
				this.loadVTVC(a.data.vtvc),
				this.video.src = b.m3u8src_v2(b.v.data[0].videoid, b.defaultVideoType),
				this.unitedStartPlay(c, !0);
					...
					!1),
					this.adplayer.addEventListener(ADConstant.UGLY_CLOSE_AD_HINT,
					function() {
			...
			onFrontAdInfoOK: function(a) {
				if (debug.log("onFrontAdInfoOK"), !0 !== this._hasStartPlay) if (0 == a.data.urls.length) this.loadVTVC(a.data.vtvc),
				this.realStartPlay(!0);
				else {
			...
			unitedStartPlay: function(a, c) {
				...
				this.controls.bindEvent(),
				this.bindEvent(),
				!0 === c ? (this.video.load(), this.video.play()) : this.onPlay(),
				this.controls.onPlay()
			},
			playVideos: function(a) {
				...
				r = 0,
				this.video.style.display = "block",
				(b.config.autoplay || b.config.nextAutoPlay || a) && (debug.log("src= " + this.video.src + " auto = " + a), this.video.load(), this.video.play())
			},
			...
			seekToLastPoint: function() {
				...
				d = -1;
				return - 1 != a && -1 != c ? (d = a, 60 > Math.abs(a - c) && (d = c)) : (d = a, -1 == a && (d = c)),
				debug.log("lastpoint=" + d),
				a = l.getItem("youku_ignore_lasttime"),
				a = parseInt(a) || 0,
				-1 !== d && d >= 120 && 3 > a && null == b.v.data[0].trial && 0 == b.v.controller.xplayer_disable && 600 <= b.v.data[0].seconds ? (this.controls.showLastTimeTip(d), e.isAndroid && (this._waitSeek = d), this.seek(d), !0) : !1
			},
			...
			skipHead: function() {
				if (!e.isAndroid) {
					...
					-1 != a && (this.controls.tipPanel.onSkipHead(), "true" == l.getItem("youku_conf_skip") && (e.isAndroid && (this._waitSeek = a / 1e3), this.seek(a / 1e3)))
				}
			},
			skipTail: function(a) {
				if (!e.isAndroid) {
					var c = parseInt((b.v.data[0].dvd || {}).tail || -1); - 1 != c && a >= c / 1e3 - 10 && !this._tailTip && (debug.log("skiptail(act before 10) =" + c), this._tailTip = !0, this.controls.tipPanel.onSkipTail()),
			...
			seek: function(a, c) {
				...
				if (this.switchTimer && clearTimeout(this.switchTimer), this.currentTime = a, this.isOnePiece()) {
					...
					1 == e.length && a < e.end(0) ? (debug.log("seek ct = " + a + ",end = " + e.end(0)), this.seekTo(a, c)) : (this.controls.onWaiting(), this.switchTimer = setTimeout(function() {
						d.seek(a, c)
					},
					100))
			...
			multiSeekTo: function(a) {
				...
				d = 0,
				e = 0,
				f = 0; f < b.videoInfo._videoSegsDic[m].length; f++) {
		...
		window.QS = function() {
			for (var a = {},
			b = window.location.search.substring(1).split("&"), c = 0; c < b.length; c++) {
				var d = b[c].split("=");
	...
	consoleBak && (window.console = consoleBak),
	module.exports = {
		YKU: YKU,
		YKP: YKP,
...
define("lib/zepto/animationShow", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a) {
		a.fn.animationShow = function(b) {
			this.each(function(c, d) {
				var e = a(d);
				e.show().removeClass("z-hide").addClass("animationShow").off("webkitAnimationEnd").on("webkitAnimationEnd",
				function(a) {
		...
		a.fn.animationHide = function(b) {
			this.each(function(c, d) {
				var e = a(d);
				e.removeClass("z-show").addClass("animationHide").off("webkitAnimationEnd").on("webkitAnimationEnd",
				function(a) {
...
define("lib/zepto/callbacks", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a) {
...
define("lib/zepto/deferred", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a) {
...
define("lib/zepto/fx_methods", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a, b) {
...
define("lib/zepto/gesture", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a) {
...
define("lib/zepto/selector", ["./zepto"],
function(a, b, c) {
	var d = a("./zepto");
	c.exports = d,
	function(a) {
...
define("modules/app/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "lib/zepto/touch", "system/util/objectUtil", "units/globalAudio", "lib/zepto/coffee"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/selector");
	a("units/lightAppAd");
	var e = (a("units/globalAudio"),
	function(a) {
		...
		function() {
			...
			k = !1,
			l = !0;
			b._$app.on("mousedown touchstart",
			function(d) {
				b._isDisableFlipPage || (a = b._$pages.filter(".z-current").get(0), c = null, a && (j = !0, k = !1, l = !0, h = 0, i = 0, "mousedown" == d.type ? (f = d.pageX, g = d.pageY) : (f = d.touches[0].pageX, g = d.touches[0].pageY), a.classList.add("z-move"), a.style.webkitTransition = "none"))
			}).on("mousemove touchmove",
			function(m) {
				if (j && (c || l) && ("mousemove" == m.type ? (h = m.pageX - f, i = m.pageY - g) : (h = m.touches[0].pageX - f, i = m.touches[0].pageY - g), Math.abs(i) > Math.abs(h))) if (i > 0) {
					if (b._isDisableFlipPrevPage) return;
					k || l ? (k = !1, l = !1, c && (c.classList.remove("z-active"), c.classList.remove("z-move")), c = a.previousElementSibling && a.previousElementSibling.classList.contains("page") ? a.previousElementSibling: e ? b._$pages.last().get(0) : !1, c && c.classList.contains("page") ? (c.classList.add("z-active"), c.classList.add("z-move"), c.style.webkitTransition = "none", c.style.webkitTransform = "translateY(-100%)", d(c).trigger("active"), a.style.webkitTransformOrigin = "bottom center") : (a.style.webkitTransform = "translateY(0px) scale(1)", c = null)) : (a.style.webkitTransform = "scale(" + (window.innerHeight / (window.innerHeight + i)).toFixed(3) + ")", c.style.webkitTransform = "translateY(-" + (window.innerHeight - i) + "px)")
				} else if (0 > i) {
					if (b._isDisableFlipNextPage) return; ! k || l ? (k = !0, l = !1, c && (c.classList.remove("z-active"), c.classList.remove("z-move")), a.nextElementSibling && a.nextElementSibling.classList.contains("page") ? c = a.nextElementSibling: (c = b._$pages.first().get(0), e = !0), c && c.classList.contains("page") ? (c.classList.add("z-active"), c.classList.add("z-move"), c.style.webkitTransition = "none", c.style.webkitTransform = "translateY(" + window.innerHeight + "px)", d(c).trigger("active"), a.style.webkitTransformOrigin = "top center") : (a.style.webkitTransform = "translateY(0px) scale(1)", c = null)) : (a.style.webkitTransform = "scale(" + ((window.innerHeight + i) / window.innerHeight).toFixed(3) + ")", c.style.webkitTransform = "translateY(" + (window.innerHeight + i) + "px)")
				}
			}).on("mouseup touchend",
			function() {
				j && (j = !1, c ? (b._isDisableFlipPage = !0, a.style.webkitTransition = "-webkit-transform 0.4s ease-out", c.style.webkitTransition = "-webkit-transform 0.4s ease-out", Math.abs(i) > Math.abs(h) && Math.abs(i) > 100 ? (k ? (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)") : (a.style.webkitTransform = "scale(0.2)", c.style.webkitTransform = "translateY(0px)"), setTimeout(function() {
					c.classList.remove("z-active"),
					c.classList.remove("z-move"),
					c.classList.add("z-current"),
					a.classList.remove("z-current"),
					a.classList.remove("z-move"),
					b._isDisableFlipPage = !1,
					b.$currentPage = d(c).trigger("current"),
					d(a).trigger("hide")
				},
				500)) : (k ? (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(100%)") : (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(-100%)"), setTimeout(function() {
					c.classList.remove("z-active"),
					c.classList.remove("z-move"),
					b._isDisableFlipPage = !1
				},
	...
	e.prototype.showPage = function(a) {
		...
		window._app_showPage ? window._app_showPage: window._app_showPage = function(a) {
			...
			case "object":
				b = d(a)
			} ! this._isFirstShowPage || b && b.length || (b = this.$currentPage, this._isFirstShowPage = !1),
			b && b.length && (this._$pages.filter(".z-current").removeClass("z-current"), b.css("-webkit-transform", "none").addClass("z-current"), b.trigger("current"), this.$currentPage = b)
		},
		this._isInitComplete ? window._app_showPage.apply(b, [a]) : d(window).one("load",
		function() {
...
define("modules/form/main", ["lib/zepto/zepto", "units/maskLayer", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/lightAppAd", "units/globalAudio", "lib/iscroll/iscroll"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("units/maskLayer"),
	e = a("modules/app/main"),
	f = a("lib/iscroll/iscroll"),
	g = d(".page-form");
	c.exports = {
		init: function() {
			g.each(function(a, b) {
				function c(a, b) {
					...
					return "radio" != c && "checkbox" != c && (a.data("value", a.val()).val(b).addClass("z-error"), a.blur()),
					i.val("请填写完整").prop("disabled", !0),
					!1
				}
				console.log("form init"),
				$page = d(b);
				var g = $page.find(".m-contactForm");
				if (g.length) {
					var h = g.find("#formContact"),
					i = h.find(".btn-submit"),
					j = $page.find(".m-contactFormLayer").maskLayer(),
					k = g.find(".successTipLayer").maskLayer({
						closeButton: !1
					}),
					l = j.maskLayer("getPluginObject"),
					m = k.maskLayer("getPluginObject");
					l.on("show",
					function() {
						e.disableFlipPage()
					}),
					...
					$page.delegate(".m-contactUs a", d.isPC ? "click": "tap",
					function() {
						l.show(),
						window.form_contactFormLayer_iScrollFloag || (window.form_contactFormLayer_iScrollFloag = !0, d(window).on("resize",
						function() {
							g.css("margin-top", 120),
							setTimeout(function() {
								g.css("margin-top", 0),
								g.parent().css("margin-top", 120)
							},
							100),
							window.navigator.userAgent.indexOf("iPhone") >= 0 && j.css("height", window.innerHeight)
						}).resize(), new f(j[0]))
					}),
					h.delegate("input.z-error", "focus",
					function() {
						var a = d(this);
						a.val(a.data("value")).removeClass("z-error"),
						i.prop("disabled", !1)
					}).delegate(".btn-submit", d.isPC ? "click": "tap",
					function() {
						i.prop("disabled") || h.submit()
					}),
					h.on("submit",
					function(a) {
						a.preventDefault();
						var b = h.find('input[name="name"]'),
						e = (h.find('input[name="sex"]'), h.find('input[name="tel"]')),
						f = h.find('input[name="company"]'),
						g = h.find('input[name="post"]'),
						i = h.find('input[name="email"]');
						...
						return f.length && 0 == d.trim(f.val()).length ? c(f, "请输入公司名称！") : g.length && 0 == d.trim(g.val()).length ? c(g, "请输入职务！") : void d.ajax({
							url: h.attr("action"),
							type: h.attr("method"),
							data: h.serialize(),
							dataType: "json",
...
define("modules/index/animationCloudBg", ["lib/zepto/zepto", "lib/zepto/data"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/data"); !
	function() {
		var a = function(a) {
			this.$target = a.addClass("m-animationCloudBg"),
...
define("modules/index/main", ["lib/zepto/zepto", "./animationCloudBg", "lib/zepto/data", "./meteorShower", "lib/zepto/touch"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
		...
		init: function() {
			...
			e.each(function(b, c) {
				...
				function() {
					...
					d(window).on("load",
					function() {
						var b = parseInt(a.data("app-id")),
						d = [3468];
						d.indexOf(b) >= 0 ? a.css("background-image", "url(/template/22/data/images/bg/app_" + b + ".jpg)") : a.addClass(c)
					})
				} (),
				$page.on("active",
				function() {
...
define("modules/index/meteorShower", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/data"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("lib/zepto/data"); !
	function() {
		var a = function(a, b) {
			this.$target = a.addClass("m-meteorShower"),
			...
			b);
			for (var c, e, f, g, h, i = "",
			j = 0; j < this.settings.starCount; j++) c = (640 * Math.random()).toFixed(2),
			...
			for (var j = 0; j < this.settings.meteorCount; j++) c = (800 * Math.random() - 280).toFixed(2),
...
define("modules/link/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/maskLayer", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/lightAppAd", "units/globalAudio"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/selector"),
	d = a("units/maskLayer"),
	...
	c.exports = {
		init: function() {
			f.each(function(a, b) {
				...
				if (c.length) {
					var f = $page.find(".m-weixinShareLayer");
					$page.find(".page-content").append(f),
					f.maskLayer({
						clickHideMode: 2,
						onShow: function() {
							e.disableFlipPage()
...
define("modules/map/main", ["lib/zepto/zepto", "units/yunlaiMap", "lib/zepto/selector", "lib/zepto/touch", "http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737", "modules/app/main", "units/lightAppAd", "units/globalAudio"],
function(require, exports, module) {
	...
	module.exports = {
		init: function() {
			$mapPages.each(function(i, item) {
				...
				$page.find(".m-distributedPoints").delegate("a", $.isPC ? "click": "tap",
				function(e) {
					var $this = $(this);
					try {
						map.show(),
						...
						if (markers) for (var markersArr = eval(markers), i = 0; i < markersArr.length; i++) {
							...
							delete marker.addr,
							delete marker.desc,
							marker.content = marker.content.replace(/(\<br\s*\/\>\s*)+/gi, "<br/>"),
				...
				function() {
					...
					distributedPointsInitFlag && (distributedPointsInitFlag = !1, a.find(".m-distributedPoints li").each(function(a, b) {
						b.style.top = b.offsetTop - b.offsetHeight + 6 + "px",
						b.style.left = b.offsetLeft - b.offsetWidth / 2 + "px",
						$(b).find("a").css("left", b.offsetWidth / 2 - 31.5)
					}))
				}).on("current",
				function() {
...
define("modules/teletext/cascadingTeletext", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/data"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("lib/zepto/data"); !
	function() {
		var a = function(a) {
			var b = this;
			this.$target = a.addClass("m-cascadingTeletext"),
			this.$_currentItem = this.$target.find("li").first().addClass("z-current"),
			d(window).on("resize",
			function() {
				b.$target.height(window.innerHeight)
			}).trigger("resize"),
			this.$target.find(".imgText").each(function(a, b) {
				0 == d.trim(b.innerText).length && d(b).remove()
			}),
			this.$target.on(d.isPC ? "click": "swipeLeft swipeRight",
			function(a) {
				b.$_currentItem.addClass("swipeLeft" == a.type ? "z-hideToLeft": "z-hideToRight")
			}).delegate("li", "webkitAnimationEnd",
			function() {
				b.$target.append(b.$_currentItem),
				b.$_currentItem.removeClass("z-current z-hideToLeft z-hideToRight"),
				b.$_currentItem = b.$target.find("li").first().addClass("z-current")
			})
		};
		a.show = function() {
...
define("modules/teletext/main", ["lib/zepto/zepto", "./cascadingTeletext", "lib/zepto/touch", "lib/zepto/data"],
function(a, b, c) {
	var d = a("lib/zepto/zepto");
		...
		init: function() {
			e.each(function(a, b) {
				...
				function() {
					...
					c.removeClass("z-viewArea").find("li.z-current").removeClass("z-current")
				}).on("current",
				function() {
					console.log("teletext current"),
					c.addClass("z-viewArea"),
					setTimeout(function() {
...
define("modules/video/main", ["lib/zepto/zepto", "lib/zepto/touch", "units/maskLayer", "lib/zepto/selector", "lib/zepto/data", "./youkuVideo", "lib/youku/jsapi", "modules/app/main", "units/lightAppAd", "units/globalAudio", "lib/zepto/coffee", "system/util/objectUtil"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("units/maskLayer"),
			...
			g.each(function(a, b) {
				...
				k = g.find(".m-youkuVideoLayer").maskLayer({
					onShow: function() {
						...
						f.pause(),
						f.isAllowManually = !1,
						c = i.youkuVideo().youkuVideo("getPluginObject")
					},
					onHide: function() {
						h.show(),
						e.enableFlipPage(),
...
define("modules/video/youkuVideo", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/selector", "lib/zepto/data", "lib/youku/jsapi"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("lib/zepto/selector"),
	...
	function() {
		...
		b = function(b, c) {
			var f = this;
			this.$target = b.addClass("m-youkuVideo"),
			this.settings = null,
			this.player = null,
			this._playerID = "videoBody_" + ++a;
			var g = this.$target.data("devid"),
			h = this.$target.data("src");
			this.settings = d.extend({
				devID: g ? g: "168eed9e805f5239",
				url: h && h.indexOf("youku") >= 0 ? h: "http://v.youku.com/v_show/id_XNzAyNDcyMzAw.html",
			...
			this.player = new e.YKU.Player(this._playerID, {
				styleid: "0",
				...
				events: {
					...
					onPlayStart: function(a) {
						f._isPlayStart = !0,
						f.settings.onPlayStart(a)
					},
					onPlayEnd: f.settings.onPlayEnd
				}
			}),
			this._isPlayStart = !1,
			this.$target.on(d.isPC ? "click": "tap",
			function() {
		...
		b.prototype._getVidByUrl = function(a) {
			...
			return b || console.log("error：视频地址不正确！"),
			b
		},
...
define("page/main", ["modules/app/main", "lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/index/main", "modules/index/animationCloudBg", "modules/index/meteorShower", "modules/teletext/main", "modules/teletext/cascadingTeletext", "modules/link/main", "units/maskLayer", "modules/video/main", "lib/zepto/touch", "modules/video/youkuVideo", "modules/map/main", "units/yunlaiMap", "modules/form/main", "lib/iscroll/iscroll"],
function(a) {
	window.app = a("modules/app/main"),
	window.app.showPage(".page-index"),
	a("modules/index/main").init(),
	a("modules/teletext/main").init(),
	a("modules/link/main").init(),
	a("modules/video/main").init(),
	a("modules/map/main").init(),
	a("modules/form/main").init(),
	console.log("\n运行成功！"),
	$(".app-footer").after($("input[data-weixin-callback]"))
}),
define("system/app", ["lib/zepto/zepto"],
function(a) {
	a("lib/zepto/zepto.js")
}),
define("system/platform", ["lib/zepto/zepto"],
function(a, b, c) {
	a("lib/zepto/zepto.js");
	c.exports = {
		device: {},
...
define("units/globalAudio", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/coffee", "system/util/objectUtil"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	...
	f = function(a) {
		this._$globalAudio = a,
		this._$tip = d("<span></span>"),
		...
		this._$globalAudio.coffee({
			steams: ['<img src="/yingqing/images/musicalNotes.png"/>', '<img src="/yingqing/images/musicalNotes.png"/>', '<img src="/yingqing/images/musicalNotes.png"/>', '<img src="/yingqing/images/musicalNotes.png"/>', '<img src="/yingqing/images/musicalNotes.png"/>', '<img src="/yingqing/images/musicalNotes.png"/>'],
			steamHeight: 100,
			steamWidth: 50
		}),
		this.audio.autoplay && (this.audio.pause(), d(window).on("load",
		function() {
			b.play()
		})),
		d(window).on("load",
		...
		this._$globalAudio.on(d.isPC ? "click": "tap",
		function(a) {
			a.preventDefault(),
			b.isAllowManually && (b._$globalAudio.is(".z-play") ? b.pause() : b.play())
		}),
		d(document).one("touchstart",
		function() {
			b.audio.play()
		})
	};
	...
	g = h.length ? new f(d(".u-globalAudio")) : e.createEmptyObject(f),
	c.exports = g
}),
define("units/lightAppAd", ["lib/zepto/zepto", "lib/zepto/touch", "system/util/objectUtil"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	e = a("system/util/objectUtil"),
	...
	f.prototype._init = function() {
		...
		if (d(".m-lightAppAd").length <= 0) {
			a.$lightAppAd = d('<div class="m-lightAppAd"><a href="javascript:void(0);" class="m-lightAppAd-link-guide"></a><div class="m-lightAppAd-body"><div class="m-lightAppAd-title"></div><a href="http://i.liveapp.cn/?a=46" class="m-lightAppAd-link-get"></a><a href="tel:4000168906" class="m-lightAppAd-link-tel"></a></div></div>'),
			d(".page:last").find(".page-content").append(a.$lightAppAd);
			var b = a.$lightAppAd.find(".m-lightAppAd-link-guide"),
			c = a.$lightAppAd.find(".m-lightAppAd-body");
			b.on(d.isPC ? "click": "tap",
			function(b) {
				a.$lightAppAd.addClass("z-showBody"),
				b.stopPropagation()
			}),
			a.$lightAppAd.on(d.isPC ? "click": "tap",
			function() {
				a.$lightAppAd.removeClass("z-showBody")
			}),
			c.on(d.isPC ? "click": "tap",
			function(a) {
				a.stopPropagation()
	...
	var g, h = d("body").data("ad");
	g = void 0 == h || 1 == h || "true" == h ? new f: e.createEmptyObject(f),
	c.exports = g
}),
define("units/maskLayer", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/selector"),
	d = a("lib/zepto/touch"),
	...
	function() {
		var a = function(a, b) {
			...
			this._events.show.push(this.settings.onShow), this._events.hide.push(this.settings.onHide), this.settings.closeButton) {
				...
				c._$maskLayer.append(e),
				e.on(d.isPC ? "click": "tap",
				function(a) {
					a.preventDefault(),
					c.hide()
				})
			}
			"show" == this.state ? c.show("_init") : c.hide("_init"),
			this.settings.clickHideMode && (c._$maskLayer.on(d.isPC ? "click": "tap",
			function() {
				c.hide()
			}), 1 == c.settings.clickHideMode && c._$maskLayer.children().on(d.isPC ? "click": "tap",
			function(a) {
				a.stopPropagation()
			}))
		};
		...
		a.prototype.show = function() {
			...
			"_init" == arguments[0] ? this._$maskLayer.addClass("z-show").show() : (this._$maskLayer.show().removeClass("z-hide").addClass("z-showing"), setTimeout(function() {
				a._$maskLayer.addClass("z-show").removeClass("z-showing"),
				a.state = "show",
				a.trigger("show")
			},
			500))
		...
		a.prototype.hide = function() {
			...
			"_init" == arguments[0] ? this._$maskLayer.addClass("z-hide").hide() : (this._$maskLayer.removeClass("z-show").addClass("z-hideing"), setTimeout(function() {
				a._$maskLayer.addClass("z-hide").removeClass("z-hideing").hide(),
				a.state = "hide",
				a.trigger("hide")
			},
			500))
		...
		d.fn.maskLayer = function(b) {
			...
			default:
				...
				if (f) {
					var g = [];
					arguments.length > 1 && (g = arguments[1]),
					f.apply(e, g)
				}
			}
			return this
...
define("units/tip", ["lib/zepto/zepto", "lib/zepto/animationShow", "lib/iscroll/iscroll"],
function(a, b, c) {
	var d = a("lib/zepto/zepto");
	d = a("lib/zepto/animationShow");
	var e = (a("lib/iscroll/iscroll"), {
		show: function() {}
	});
	c.exports = e
}),
define("units/weixin", ["lib/zepto/zepto"],
function(a, b, c) {
	var d = a("lib/zepto/zepto");
	c.exports = d,
	function(a) {
		a.fn.wx = function(b) {
			function c(a, b) {
				var d = 2e3;
				b = b || 0,
				!0 === window.G_WEIXIN_READY || "WeixinJSBridge" in window ? a.apply(null, []) : d >= b && setTimeout(function() {
					c(a, b++)
				},
				15)
			}
			...
			!1); {
				...
				g = {
						...
						weibo: function(a, b) {
							c(function() {
								...
								function() {
									...
									function(a) { - 1 == a.err_msg.indexOf("cancel") && f.execAfterMergerHandler(b, [a])
									})
								})
							})
						},
					...
					setToolbar: function(a, b) {
						c(function() {
							WeixinJSBridge.call(!0 === a ? "showToolbar": "hideToolbar"),
							f.execAfterMergerHandler(b, [a])
						})
					},
					setOptionMenu: function(a, b) {
						c(function() {
							WeixinJSBridge.call(!0 === a ? "showOptionMenu": "hideOptionMenu"),
							f.execAfterMergerHandler(b, [a])
						})
					},
					pay: function(a, b) {
						c(function() {
							...
							WeixinJSBridge.invoke("getBrandWCPayRequest", c,
							function(a) {
								var b = "get_brand_wcpay_request:";
								switch (a.err_msg) {
								case b + "ok": e = d.success;
									break;
								case b + "fail": e = d.fail || d.error;
									break;
								case b + "cancel": e = d.cancel || d.error;
									break;
								default:
									e = d.error
								}
			...
			return g.Share.timeline(i, e.handler),
			g.Share.message(i, e.handler),
			g.Share.weibo(h, e.handler),
			d
		},
		a.fn.wx.defaults = {
			title: "云来场景应用",
...
define("units/ylmap", ["lib/zepto/zepto"],
function(a, b, c) {
	var d = a("lib/zepto/zepto");
	c.exports = d,
	function(a) {
...
define("units/yunlaiMap", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/selector"),
	d = a("lib/zepto/touch");
	window.BMap_loadScriptTime = (new Date).getTime(),
	a("http://api.map.baidu.com/getscript?v=1.4&ak=&services=&t=20140320104737"),
	function() {
		var a = 0,
		b = function(b, c) {
			var e = this;
			this._$yunlaiMap = b.addClass("u-yunlaiMap"),
			this._mapID = "map-" + ++a,
			this._$mapBox = d('<div id="' + this._mapID + '" class="baiduMap"></div>'),
			this._$mapToolBar = d('<div class="mapToolBar"><a href="javascript:void(0);" class="closeMap">关闭</a><span class="navigationControl"><a href="javascript:void(0);" class="z-current" data-route-type="1">公交</a><a href="javascript:void(0);" data-route-type="2">自驾</a><a href="javascript:void(0);" data-route-type="3">步行</a></span><span class="navigationTip">正在获取您所在的位置...</span></div>'),
			...
			this._$mapRoutePanel = d('<div class="mapRoutePanel"><div id="routeResult_' + a + '" class="routeResult"><p class="noRouteInfo">暂无路线信息！</p></div><a href="javascript:void(0);" class="toggle"></a></div>'),
			this._baiduMap = null,
			this.markers = [],
			this._activedPoint = new BMap.Point(116.404, 39.915),
			this.settings = d.extend({
				markers: [],
				mapType: 0
			},
			...
			this._$yunlaiMap.is(".z-hide") && this._$yunlaiMap.hide(),
			this._baiduMap = new BMap.Map(e._mapID, {
				mapType: e._util.mapTypes[e.settings.mapType]
			}),
			this._baiduMap.enableScrollWheelZoom(),
			this._baiduMap.enableInertialDragging(),
			this._baiduMap.centerAndZoom(e._activedPoint, 12);
			var f = new BMap.MapTypeControl({
				mapTypes: [BMAP_NORMAL_MAP, BMAP_HYBRID_MAP]
			});
			f.setOffset(new BMap.Size(145, 246)),
			this._baiduMap.addControl(f),
			this._$yunlaiMap.delegate(".closeMap", "click",
			function(a) {
				a.preventDefault(),
				e.hide()
			}),
			this._$navigationControl.delegate("a", "click",
			function() {
				var a = d(this),
				b = a.data("route-type");
				e.drawRoute(null, e._activedPoint, b),
				e._setNavigationMode(b)
			}),
			this._$mapRoutePanel.delegate(".toggle", "click",
			function() {
				e._$mapRoutePanel.toggleClass("z-show")
			}),
			this._$yunlaiMap.on("mousedown mousemove mouseup touchstart touchmove touchend",
			function(a) {
				a.stopPropagation()
			})
		};
		...
		b.prototype.show = function() {
			...
			setTimeout(function() {
				a._$yunlaiMap.removeClass("z-hide"),
				a.trigger("show")
			},
			0),
		...
		b.prototype._updateNavigationInfo = function(a, b) {
			switch (a) {
			case 0:
				this._showNavigationTip(b ? b: "正在获取您所在的位置...", "loading"),
				this._$mapRoutePanel.removeClass("z-show").find(".routeResult").html('<p class="noRouteInfo">暂无路线信息！</p>'),
				console.log(b ? b: "正在获取您所在的位置...");
				break;
			case 1:
				this._showNavigationTip(b ? b: "获取位置失败！", "error", 5e3),
				console.log(b ? b: "获取位置失败！");
				break;
			case 2:
				this._showNavigationTip(b ? b: "正在绘制公交路线！", "loading"),
				this._setNavigationMode(1),
				console.log(b ? b: "正在绘制公交路线！");
				break;
			case 3:
				this._showNavigationTip(b ? b: "正在绘制驾车路线！", "loading"),
				this._setNavigationMode(2),
				console.log(b ? b: "正在绘制驾车路线！");
				break;
			case 4:
				this._showNavigationTip(b ? b: "正在绘制步行路线！", "loading"),
				this._setNavigationMode(3),
				console.log(b ? b: "正在绘制步行路线！");
				break;
			case 5:
				this._showNavigationTip(b ? b: "路线绘制成功！", "success", 1e3),
				console.log(b ? b: "路线绘制成功！");
				var c = this;
				setTimeout(function() {
					c._$navigationTip.html("").hide(),
					c._$navigationControl.show(),
					c._$mapRoutePanel.show().addClass("z-show")
				},
				1e3);
				break;
			case 6:
				this._showNavigationTip(b ? b: "路线绘制失败！", "error", 5e3),
				this._$mapRoutePanel.removeClass("z-show"),
				console.log(b ? b: "路线绘制失败！")
			}
		},
		...
		b.prototype._setNavigationMode = function(a) {
			...
			b.filter(".z-current").removeClass("z-current"),
			b.filter('[data-route-type="' + a + '"]').addClass("z-current")
		},
		b.prototype.addMarker = function(a) {
			...
			return a.title && f.setTitle(a.title),
			a.content && f.setContent(a.content + g),
			a.title && a.content || b._util.geocoder.getLocation(c,
			function(b) {
			...
			function() {
				...
				b._activedPoint = this.point,
				window._yunlaiMap_initRouted || (window._yunlaiMap_initRouted = !0, d(".BMap_bubble_content").delegate(".navigationButtons a", "click",
				function() {
					var a = e.getPosition(),
		...
		b.prototype.addMarkers = function(a) {
			for (var b = this,
			c = 0; c < a.length; c++) b.addMarker(a[c])
		},
		...
		b.prototype.drawRoute = function(a, b, c) {
			...
			} else d._updateNavigationInfo(0),
			d._util.geolocation.getCurrentPosition(function(a) {
		...
		b.prototype.clearRoutes = function() {
			this._transitRoute && this._transitRoute.clearResults(),
			this._drivingRoute && this._drivingRoute.clearResults(),
			this._walkingRoute && this._walkingRoute.clearResults(),
			this._$navigationControl.hide(),
			this._$mapRoutePanel.removeClass("z-show").find(".routeResult").html('<p class="noRouteInfo">暂无路线信息！</p>')
		},
