# tutorial from: http://machinelearningmastery.com/machine-learning-in-python-step-by-step/
...
def analysis():
    ...
    # dataset.plot(kind='box', subplots=True, layout=(1, 4), sharex=True, sharey=True)
